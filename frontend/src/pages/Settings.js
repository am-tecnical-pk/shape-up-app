...
import { Container, Row, Col, Form, Button, Modal, Nav, Badge, Accordion } from "react-bootstrap"; // Added Accordion
      ...
      <Container className="py-5" style={{maxWidth: '1100px'}}>
        ...
        <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)} centered>
            ...
            <Modal.Footer className="justify-content-center border-0 pb-4">
                ...
                <Button variant="danger" className="fw-bold">Yes, Delete Everything</Button>
            </Modal.Footer>
        </Modal>
