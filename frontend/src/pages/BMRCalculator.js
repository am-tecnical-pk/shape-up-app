...
// --- Result Row ---
const ResultRow = ({ label, value, unit, highlight = false }) => (
    <div className={`d-flex justify-content-between align-items-center p-3 mb-2 rounded-3 ${highlight ? 'bg-primary bg-opacity-10 border border-primary' : 'bg-light border'}`}>
...
// --- Macro Card ---
const MacroCard = ({ label, grams, cals, color, percent }) => (
    <div className="text-center p-3 rounded-4 border bg-white h-100 shadow-sm macro-card">
    ...
    <div className="page-wrapper position-relative">
      ...
      <style>
        {`
          ...
          /* SLIDER STYLING */
          .custom-range::-webkit-slider-thumb { background: #0d6efd; cursor: pointer; }
          .custom-range::-moz-range-thumb { background: #0d6efd; cursor: pointer; }
          ...
          /* MACRO CARDS */
          .macro-card { transition: 0.3s; }
          .macro-card:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.1); }
          ...
          /* GOAL BUTTONS */
          .btn-goal { border: 1px solid transparent; color: #6c757d; }
          .btn-goal.active { background-color: #ffc107; color: #000; border-color: #ffc107; box-shadow: 0 4px 10px rgba(255, 193, 7, 0.3); }
      ...
      <Container className="py-5 position-relative" style={{zIndex: 2}}>
        ...
        <Row className="g-5">
            ...
            <Col lg={6} className="fade-in" style={{ animationDelay: "0.2s" }}>
               <div className="content-panel p-4 p-md-5 h-100">
                  
                  <div className="d-flex justify-content-between align-items-center mb-4">
                      <h4 className="fw-bold mb-0 text-adaptive-head"><FaCalculator className="me-2 text-primary"/>Parameters</h4>
                      <Button variant="outline-secondary" size="sm" onClick={handleReset} className="rounded-pill px-3"><FaUndo className="me-1"/>Reset</Button>
                  </div>
                  ...
                  <Form>
                      ...
                      <div className="mb-4">
                          ...
                          <div className="d-flex gap-3">
                              <Button 
                                ...
                                className="flex-grow-1 py-2 rounded-pill d-flex align-items-center justify-content-center"
                      ...
                      <div className="mb-5 p-3 rounded-4 bg-light border">
            ...
            {/* RIGHT COLUMN: RESULTS (FETCHED & CALCULATED) - PRINT BUTTON REMOVED */}
            <Col lg={6} className="fade-in" style={{ animationDelay: "0.4s" }}>
                <div className="content-panel h-100 p-4 p-md-5 d-flex flex-column bg-gradient-panel">
                    
                    <div className="text-center mb-4">
                        <div className="d-inline-flex p-3 bg-success bg-opacity-10 text-success rounded-circle mb-3 shadow-sm">
                            <FaAppleAlt size={24} />
                        </div>
                    ...
                    {/* Main Stats */}
                    <div className="mb-4">
                        <ResultRow label="BMR (Resting)" value={bmr} unit="kcal/day" />
                        <ResultRow label="TDEE (Maintenance)" value={tdee} unit="kcal/day" />
                        <div className="my-3"></div>
                        <div className="p-3 rounded-3 bg-primary text-white shadow d-flex justify-content-between align-items-center">
