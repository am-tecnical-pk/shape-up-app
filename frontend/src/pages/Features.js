...
import { 
  FaDumbbell, FaAppleAlt, FaCalculator, FaUserPlus, FaUtensils, FaTint,
  FaArrowRight, FaCheckCircle, FaBolt, FaMobileAlt, FaChartPie, FaBrain,
  FaGoogle, FaApple, FaHeartbeat, FaSpotify, FaStrava
} from "react-icons/fa"; 
import Footer from "../components/Footer";

// --- IMAGES (Using Reliable Online URLs) ---
...
const FeatureCard = ({ title, description, link, icon: Icon, color, delay }) => (
    <div className="card-wrapper" style={{ animationDelay: delay }}>
      <Link to={link} className="text-decoration-none">
        <Card className="h-100 border-0 shadow-sm feature-card rounded-4">
          ...
          <Card.Body className="p-4 p-lg-5 position-relative z-1">
            ...
            <Card.Text className="text-adaptive-sub mb-4">{description}</Card.Text>
...
const DetailedFeatureSection = ({ title, text, img, isReversed, badge }) => (
    <div className="py-5 my-5">
        <Row className={`align-items-center ${isReversed ? 'flex-row-reverse' : ''}`}>
            <Col lg={6} className="mb-4 mb-lg-0 fade-in-up">
                <div className="feature-img-box rounded-5 shadow-lg overflow-hidden position-relative">
                    <img src={img} alt={title} className="img-fluid w-100 object-fit-cover" style={{minHeight: '350px'}} />
                    <div className="img-overlay"></div>
                </div>
            </Col>
            <Col lg={6} className={`fade-in-up ${isReversed ? 'pe-lg-5' : 'ps-lg-5'}`}>
                ...
                <Button variant="outline-primary" className="mt-4 rounded-pill px-4 fw-bold">Learn More</Button>
            </Col>
        </Row>
    </div>
);
...
const ComparisonTable = () => (
    <div className="glass-panel p-4 p-md-5 rounded-5 mt-5 fade-in-up">
...
const CTASection = () => (
  <Container className="py-5 my-5">
    <div className="cta-box rounded-5 p-5 text-center text-white position-relative overflow-hidden fade-in-up">
      <div className="position-relative z-1">
        ...
        <Button as={Link} to="/pages/register" variant="light" size="lg" className="rounded-pill px-5 fw-bold text-primary">
    ...
    <div className="page-wrapper position-relative overflow-hidden">
      ...
      <style>
        {`
          ...
          .btn-outline-glow { border: 2px solid #dee2e6; color: #212529; background: transparent; transition: 0.3s; }
          .btn-outline-glow:hover { border-color: #212529; color: #212529; transform: translateY(-3px); }
          body.dark-mode .btn-outline-glow { border-color: rgba(255,255,255,0.2); color: white; }
          ...
          .feature-card:hover { transform: translateY(-10px); box-shadow: 0 20px 40px rgba(0,0,0,0.1) !important; border-color: #0d6efd !important; }
          body.dark-mode .feature-card:hover { box-shadow: 0 20px 40px rgba(0,0,0,0.3) !important; border-color: #38bdf8 !important; }
      ...
      {/* 1. HERO */}
      <div className="text-center position-relative py-5 mb-5 hero-section fade-in-up">
        <Container>
      ...
      <Container className="pb-5">
        <Row className="mb-5 text-center fade-in-up" style={{animationDelay: '0.2s'}}>
          <Col>
      ...
      <Container className="py-5 mb-5">
         <Row className="justify-content-center">
            <Col lg={8}>
                ...
                <Accordion defaultActiveKey="0" className="fade-in-up">
                    {FAQS.map((faq, idx) => (
