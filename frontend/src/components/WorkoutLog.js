...
import { FaCalendarAlt, FaDumbbell, FaClipboardList, FaCheckCircle, FaRobot, FaFire } from "react-icons/fa";
                  ...
                  <div className="text-center fade-in">
                      ...
                      {aiAnalysisResult.nextWeekAdjustments?.length > 0 && (
                          <Card className="text-start border-0 bg-light mb-3">
                              <Card.Body>
                                  <h6 className="fw-bold text-danger mb-3 d-flex align-items-center"><FaFire className="me-2"/> Recommended Changes for Next Week:</h6>
                                  <ul className="mb-0 ps-3">
                                      {aiAnalysisResult.nextWeekAdjustments.map((adj, i) => (
                                          <li key={i} className="mb-1">
                                              <strong>{adj.exercise}:</strong> {adj.adjustment}
                                          </li>
                                      ))}
                                  </ul>
                              </Card.Body>
